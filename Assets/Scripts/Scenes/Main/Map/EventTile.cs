...
public class EventTile : Tile
{
    ...
    void AncientTreasure()
    {
        ...
        string msg = "触发事件【古代宝藏】: 获得 200 金币！";
        Debug.Log(msg);
    ...
    void WanderingMerchant()
    {
        ...
        string msg = "触发事件【流浪商人】: 获得 150 建材！";
        Debug.Log(msg);
        MessageLogUI.Instance?.AddMessage(msg);
    }
    ...
    void HeroBlessing()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            p.deck.AddCard(card);
            string msg = $"触发事件【英雄遇仙】: 获得 {card.cardName} Lv1！";
            Debug.Log(msg);
            MessageLogUI.Instance?.AddMessage(msg);
        }
    }
    ...
    void BanditRaid()
    {
        ...
        string msg = $"触发事件【强盗袭击】: 损失 {lose} 金币！";
        Debug.Log(msg);
        MessageLogUI.Instance?.AddMessage(msg);
    }
    ...
    void Sandstorm()
    {
        ...
        string msg = "触发事件【沙尘暴】: 本回合无法再进行主操作！";
        Debug.Log(msg);
        MessageLogUI.Instance?.AddMessage(msg);
    }
